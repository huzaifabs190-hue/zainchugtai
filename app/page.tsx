...
export default function Home() {
  ...
  return <main>
    ...
    <footer id="contact"><div className="footer-main"><div><a className="footer-wordmark" href="#top" aria-label="Insurance and Financial Realty home"><strong>INSURANCE &amp; FINANCIAL</strong><small>REALTY LLC</small></a><p>Solutions that fit your world.</p></div><div><small>CONTACT</small><a href={`tel:${phone}`} aria-label="Call Insurance and Financial Realty at 718 844 1340">(718) 844-1340</a><a href="#quote">Send an online request</a><a href={`mailto:${email}?subject=Insurance%20and%20Financial%20Realty%20inquiry`}>{email}</a></div><div><small>VISIT</small><a target="_blank" rel="noreferrer" href="https://www.google.com/maps/search/?api=1&query=Insurance+%26+Financial+Realty+LLC%2C+1019+Farmington+Ave+Unit+5%2C+Bristol%2C+CT+06010" aria-label="Open the office location in Google Maps">1019 Farmington Ave<br/>Suite 5<br/>Bristol, CT 06010</a></div><div><small>EXPLORE</small><a href="#services">Services</a><a href="#about">About</a><a href="#quote">Free quote</a><a href="/privacy">Privacy policy</a><a href="/disclaimer">Insurance disclaimer</a></div></div><div className="footer-bottom"><p>© 2026 Insurance &amp; Financial Realty LLC</p><p>Zain Chughtai · Owner · Licensed Broker</p><a href="#top">Back to top ↑</a></div></footer>
